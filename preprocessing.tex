...
In this project, we have output data from quartus OpenCL compiler for three benchmarks: dfadd, dfsin and dfmul. Table \ref{table:benchmark_record} shows the number of data records for each benchmark.
